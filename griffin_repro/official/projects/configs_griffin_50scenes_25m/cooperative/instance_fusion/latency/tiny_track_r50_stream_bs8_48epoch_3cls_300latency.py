...
info_root = f"./data/infos/{dataset_prefix}/{v2x_side}-delay-3/"
...
log_config = dict(
    ...
    hooks=[
        ...
        #     init_kwargs=dict(
        #         project='griffin',
        #         name=f'{dataset_prefix}_{v2x_side}_tiny_r50_bs{batch_size}x{num_gpus}_{num_epochs}e_3cls_300latency',
        #     ),
        # ),
    ],
)
